...
/*   Updated: 2021/06/23 18:27:07 by nagresel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
                    ...
                    ranged_damage(20), semicustom_damage(45)
{
    ...
    << std::endl << "FR4G-TP "<< _name << ": \"Commencing directive three! Uhntssuhntssuhntss--\""
    << std::endl << "Jack: \"Ugh, friggin' hate that guy.\""
    << std::endl;
    srand(time(NULL));
}
...
FragTrap::~FragTrap()
{
    std::cout << "FR4G-TP "<< _name << ": \"Ooh, squishy bits!\"" << std::endl;
}
...
void    FragTrap::takeDamage(unsigned int amount)
{
    ...
    if (_nrj_points <= 0)
    std::cout << _name << ": \"I'm dead I'm dead, Oh my god! I'm dead.\"" << std::endl;
}
